...
public class FaceDetector implements Runnable {
	...
	private static final String JOHANNESBURG = "Randburg";
                            ...
                            for (int i = 0; i < total; i++) {
                                ...
                                if (isRecFace) {
                                    ...
                                    if (recogniseCode != -1) {
                                        ...
                                        COUNTER++;
                                        if (COUNTER > 15) {
                                            FileInputStream refreshToken = new FileInputStream("src/refreshToken2.json");
                                            ...
                                            Message message = Message.builder().setNotification(new Notification("Emergency", "Hello, we have detected an unknown person using your laptop."))
                                                    .setTopic(JOHANNESBURG)
                                                    .build();
